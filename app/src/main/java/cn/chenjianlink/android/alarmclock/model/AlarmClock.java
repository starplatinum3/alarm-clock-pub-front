...
//@Entity(tableName = Commons.alarmClockTableName)
//@Entity(tableName = AlarmClock.tableName)
@Entity(tableName = "clock_table")
//@Entity(tableName = AlarmClock.class.f)
public class AlarmClock {

//    public static final String tableName  = "AlarmClock";
//    public static final String tableName  = "clock_table";
    /**
     * 闹钟id
     */
